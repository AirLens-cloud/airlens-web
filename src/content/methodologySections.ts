...
export const METHODOLOGY_SECTIONS: MethodologySection[] = [
  {
    ...
    what: 'Every value AirLens renders carries a "nature" tag describing how it came to exist: observed at a station, interpolated between stations, derived from a satellite pass, forecast by a model, or inferred through causal analysis.',
    why: 'A number alone hides how much to trust it. Marking nature at the value lets you tell "measured right here" apart from "estimated for here" without reading a footnote.',
    ...
    relatedTermIds: ['nature', 'interpolated', 'forecast'],
  ...
  },
  {
    ...
    what: 'A value estimated for a point with no direct sensor, filled in from nearby measurements.',
    why: 'Ground stations are sparse; interpolation lets AirLens show a reasonable estimate between them instead of a blank map.',
    limitations: 'Accuracy degrades with distance from the nearest real sensor — interpolated values in low-coverage regions carry wider uncertainty.',
    relatedTermIds: ['interpolated', 'coverage', 'p10-p90'],
  },
  {
