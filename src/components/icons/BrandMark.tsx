 ...
 * Ambient motion (04-motion-system.md "내비 마크" scene): a one-shot spring
 * pop on mount, a 6s ambient breathe, and a 1.6s breathe on hover — all
 * defined as CSS on the `.brandmark`/`.band-mid`/`.band-outer`/`.core`/`.rim`
 * classes below in src/styles/motion.css (reduced-motion disables all of it).
 *
    ...
    >
      <defs>
        ...
        <radialGradient id={id('dot')} cx="34%" cy="28%" r="72%">
          ...
          <stop offset=".75" style={{ stopColor: 'var(--orange)' }} />
      ...
      <g className="core">
      <circle cx={128} cy={128} r={33.75} style={{ fill: 'var(--orange)' }} opacity={0.35} filter={`url(#${id('glowSm')})`} />
