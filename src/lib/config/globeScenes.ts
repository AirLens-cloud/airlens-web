...
export const GLOBE_SCENES: GlobeSection[] = [
  { key: 'aq', ko: '대기질', en: 'AIR QUALITY', desc_ko: 'PM2.5 격자 예측 — 지상 관측·기상 조건부', desc_en: 'Global PM2.5 grid prediction — ground + weather conditioned', layers: { grid: true, wind: true, fires: false, arcs: false, stations: false, choropleth: false }, overlay: 'pm25' },
